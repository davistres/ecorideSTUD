...
<div class="modal" id="tripDetailsModal">
    <div class="modal-content trip-details-modal-content">
                ...
                <div class="driver-details-container">
                    <div class="details-vehicle">
                        ...
                        <div class="vehicle-info">
                            ...
                            <p><span class="vehicle-label-details">Marque :</span> <span id="modal-brand"></span></p>
                            <p><span class="vehicle-label-details">Modèle :</span> <span id="modal-model"></span></p>
                            <p><span class="vehicle-label-details">Couleur :</span> <span id="modal-color"></span></p>
                            <p><span class="vehicle-label-details">Energie :</span> <span id="modal-energie"></span></p>
                        </div>
                    </div>
        ...
        <div class="modal-footer">
            <a href="#" class="btn-base btn-participate" id="modal-participate-btn">Participer</a>
        </div>
    </div>
</div>
